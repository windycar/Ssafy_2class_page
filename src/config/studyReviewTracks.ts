...
export const STUDY_REVIEW_TRACKS: readonly StudyReviewTrack[] = [
  ...
  {
    id: "special-mock-a5-r1",
    label: "특별 모의고사 5-1",
    description: "과목평가 5회차 · 모의고사 1회차",
    href: "/study/special-mock/5/1/quiz?mode=wrong",
    tone: "amber",
    source: "special-mock-exam",
    assessmentRound: 5,
    round: 1,
  ...
  {
    id: "special-mock-a5-r2",
    label: "특별 모의고사 5-2",
    description: "과목평가 5회차 · 모의고사 2회차",
    href: "/study/special-mock/5/2/quiz?mode=wrong",
    tone: "amber",
    source: "special-mock-exam",
    assessmentRound: 5,
    round: 2,
  ...
  {
    id: "special-mock-a5-r3",
    label: "특별 모의고사 5-3",
    description: "과목평가 5회차 · 모의고사 3회차",
    href: "/study/special-mock/5/3/quiz?mode=wrong",
    tone: "amber",
    source: "special-mock-exam",
    assessmentRound: 5,
    round: 3,
  ...
  {
    id: "special-mock-a5-r4",
    label: "특별 모의고사 5-4",
    description: "과목평가 5회차 · 모의고사 4회차",
    href: "/study/special-mock/5/4/quiz?mode=wrong",
    tone: "amber",
    source: "special-mock-exam",
    assessmentRound: 5,
    round: 4,
  ...
  {
    id: "special-mock-a5-r5",
    label: "특별 모의고사 5-5",
    description: "과목평가 5회차 · 모의고사 5회차",
    href: "/study/special-mock/5/5/quiz?mode=wrong",
    tone: "amber",
    source: "special-mock-exam",
    assessmentRound: 5,
    round: 5,
